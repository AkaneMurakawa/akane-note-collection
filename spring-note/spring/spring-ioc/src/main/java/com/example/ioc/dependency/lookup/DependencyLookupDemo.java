package com.example.ioc.dependency.lookup;


import com.example.ioc.dependency.annotation.Super;
...
public class DependencyLookupDemo {
    ...
    public static void main(String[] args) {
        ...
        /**
         *  No qualifying com.example.bean of type 'com.example.ioc.dependency.domain.User' available: expected single matching com.example.bean but found 2: user,superUser
         *  配置primary="true">
         */
