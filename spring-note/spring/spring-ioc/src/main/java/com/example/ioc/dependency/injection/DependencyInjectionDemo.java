package com.example.ioc.dependency.injection;

import com.example.ioc.dependency.repository.UserRepository;
...
//        ApplicationContext applicationContext = new ClassPathXmlApplicationContext("classpath:/META-INF/dependency-injection-context.xml");
    ...
    private static void dependencySource(BeanFactory beanFactory) {
        // 依赖来源一: 自定义 Bean
        // com.example.ioc.dependency.repository.UserRepository
        UserRepository userRepository = beanFactory.getBean("userRepository", UserRepository.class);
